const PostItem = (post) => {
    return(`
        <div class="d-flex flex-row overflow-hidden wd-border-bottom wd-font wd-font-13">
            ...
            <div class="float-end mt-3 ms-3 wd-font-15 wd-font-color-gray me-3">
                ...
                <div class="mt-2 border-1">
                    <div class="wd-border-style rounded-3 overflow-hidden" style="margin-right: 48px">
                        <img class="wd-article-image" width="504px" style="max-width: 100%; height: 100%" height="264px" src=${post.ArticleImage}/>
                        <div class="p-2">
